...
- スペイン語のen cambio（「一方で」を表す副詞的なつなぎ言葉、mientras queとの違い）── 09-15のwhile/whereas（対比）の逆向きブリッジ、接続詞ではなく独立した文をつなぐ副詞として使う点を整理する
...
- 2026-09-15: 英語のwhile/whereasの対比用法（「〜する一方で」）── 09-14の品詞整理とは別の「意味」の軸で、驚きのある譲歩(although/despite)と驚きのない対比(while/whereas)を切り分け、whileの二刀流(時間/対比)とwhereasの対比専門・フォーマルな性質を整理し、スペイン語のmientras/mientras queとの対応も紹介した
